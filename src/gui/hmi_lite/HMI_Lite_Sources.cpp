...
lv_obj_t *Screen_lite_notified_obj;
lv_obj_t *Screen_lite_label_wifi;
lv_obj_t *Screen_lite_label_bluetooth;
lv_obj_t *Screen_lite_label_warning;
lv_obj_t *Screen_lite_label_SD;
lv_obj_t *Screen_lite_label_modbus_active;
lv_obj_t *Screen_lite_label_time;

typedef struct Notified_Bar_lite
{
...
Notified_Bar_lite Notified_Bar_lite;
...
{
	//create notified obj
	Screen_lite_notified_obj = lv_obj_create(screen);
	lv_obj_set_pos(Screen_lite_notified_obj, 0, 0);
	lv_obj_set_size(Screen_lite_notified_obj, 160, 20);
	//create font wifi
	Screen_lite_label_wifi = lv_label_create(Screen_lite_notified_obj);
	lite_setup_label(Screen_lite_label_wifi,"wifi",-10,-15,15,15);
	lv_label_set_text(Screen_lite_label_wifi,LV_SYMBOL_WIFI);
	//create font bluetooth
	Screen_lite_label_bluetooth = lv_label_create(Screen_lite_notified_obj);
	lite_setup_label(Screen_lite_label_bluetooth,"bluetooth",5,-15,15,15);
	lv_label_set_text(Screen_lite_label_bluetooth,LV_SYMBOL_BLUETOOTH);
	//create font warning
	Screen_lite_label_warning = lv_label_create(Screen_lite_notified_obj);
	lite_setup_label(Screen_lite_label_warning,"warning",20,-15,15,15);
	lv_label_set_text(Screen_lite_label_warning,LV_SYMBOL_WARNING);
	//create font modbus_active
	Screen_lite_label_modbus_active = lv_label_create(Screen_lite_notified_obj);
	lite_setup_label(Screen_lite_label_modbus_active,"modbus_active",50,-15,15,15);
	lv_label_set_text(Screen_lite_label_modbus_active,LV_SYMBOL_REFRESH);
	//create font SD
	Screen_lite_label_SD = lv_label_create(Screen_lite_notified_obj);
	lite_setup_label(Screen_lite_label_SD,"SD Card",37,-15,10,15);
	lv_label_set_text(Screen_lite_label_SD,LV_SYMBOL_SD_CARD);

	//create label time
	Screen_lite_label_time = lv_label_create(Screen_lite_notified_obj);
	sprintf(Notified_Bar_lite.time, "%d:%d",Notified_Bar_lite.hour,Notified_Bar_lite.minute);
	lite_setup_label(Screen_lite_label_time, Notified_Bar_lite.time,90,-15,40,15); 
}