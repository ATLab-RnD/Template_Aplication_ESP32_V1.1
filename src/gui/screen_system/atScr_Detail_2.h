...
void  Scr_Detail_2::Start()
{
	...
	atScr_Detail_2.render_modbus_icon(atScr_Detail_2.Screen_label_modbus,atScr_Detail_2.modbus_active_old,30,0);
...
void Scr_Detail_2::Update()
{
	...
	if (atScr_Detail_2.Notified_Bar_1.minute < 60)
	{
		atScr_Detail_2.Notified_Bar_1.minute ++;
	}
	else 
	{
		atScr_Detail_2.Notified_Bar_1.minute = 0;
		if(atScr_Detail_2.Notified_Bar_1.hour < 22)
			atScr_Detail_2.Notified_Bar_1.hour ++;
		else atScr_Detail_2.Notified_Bar_1.hour = 0;
	}
	sprintf(atScr_Detail_2.Notified_Bar_1.time,"%d:%d",atScr_Detail_2.Notified_Bar_1.hour,atScr_Detail_2.Notified_Bar_1.minute);
	atScr_Detail_2.setup_label(atScr_Detail_2.Screen_label_time,atScr_Detail_2.Notified_Bar_1.time,120,0,40,15);
	//check active wifi
	if(atScr_Detail_2.wifi_active != atScr_Detail_2.wifi_active_old)
	{
		atScr_Detail_2.wifi_active_old = atScr_Detail_2.wifi_active;
		atScr_Detail_2.render_wifi_icon(atScr_Detail_2.Screen_label_wifi,atScr_Detail_2.wifi_active_old);
	}
	//check SD card active
	if (atScr_Detail_2.SD_active != atScr_Detail_2.SD_active_old)
	{
		atScr_Detail_2.SD_active_old = atScr_Detail_2.SD_active;
		atScr_Detail_2.render_SD_Card_icon(atScr_Detail_2.Screen_label_SD,atScr_Detail_2.SD_active_old);
	}
	//check modbus active
	if (atScr_Detail_2.modbus_active != atScr_Detail_2.modbus_active_old)
	{
		atScr_Detail_2.modbus_active_old = atScr_Detail_2.modbus_active;
		atScr_Detail_2.render_modbus_icon(atScr_Detail_2.Screen_label_modbus,atScr_Detail_2.modbus_active_old);
	}	
	//check warning active
	if (atScr_Detail_2.warning_active != atScr_Detail_2.warning_active_old)
	{
		atScr_Detail_2.warning_active_old = atScr_Detail_2.warning_active;
		atScr_Detail_2.render_warning_icon(atScr_Detail_2.Screen_label_warning,atScr_Detail_2.warning_active_old);
	}
}
#endif