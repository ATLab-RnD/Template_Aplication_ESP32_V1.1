...
void  Scr_Detail_2::Start()
{
	...
	atScr_Detail_2.setup_label(atScr_Detail_2.label_screen,"Detail_1.title",LABEL_POS_X,LABEL_POS_Y,100,32);
	//create notified bar
	...
	atScr_Detail_2.render_time(atScr_Detail_2.Screen_label_time,atScr_Detail_2.Notified_Bar_old_1.hour,atScr_Detail_2.Notified_Bar_old_1.minute,ICON_TIME_POS_X,ICON_TIME_POS_Y);
...
void Scr_Detail_2::Update()
{
	if((atScr_Detail_2.Notified_Bar_old_1.hour != atScr_Detail_2.Notified_Bar_1.hour) || (atScr_Detail_2.Notified_Bar_old_1.minute != atScr_Detail_2.Notified_Bar_1.minute))
	{
		...
		atScr_Detail_2.render_time(atScr_Detail_2.Screen_label_time,atScr_Detail_2.Notified_Bar_old_1.hour,atScr_Detail_2.Notified_Bar_old_1.minute);
	}
	//check active wifi
