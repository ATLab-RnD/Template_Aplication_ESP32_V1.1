...
void  Scr_Detail_3::Start()
{
	...
	atScr_Detail_3.render_modbus_icon(atScr_Detail_3.Screen_label_modbus,atScr_Detail_3.Notified_Bar_old_1.modbus_active,30,0);
	atScr_Detail_3.render_wifi_icon(atScr_Detail_3.Screen_label_wifi,atScr_Detail_3.Notified_Bar_old_1.wifi_active,0,0);
	atScr_Detail_3.render_SD_Card_icon(atScr_Detail_3.Screen_label_SD,atScr_Detail_3.Notified_Bar_old_1.SD_active,15,0);
	atScr_Detail_3.render_warning_icon(atScr_Detail_3.Screen_label_warning,atScr_Detail_3.Notified_Bar_old_1.warning_active,45,0);
	sprintf(atScr_Detail_3.char_time,"%d:%d",atScr_Detail_3.Notified_Bar_old_1.hour,atScr_Detail_3.Notified_Bar_old_1.minute);
	atScr_Detail_3.setup_label(atScr_Detail_3.Screen_label_time,atScr_Detail_3.char_time,120,0,40,15);
	// init every events
...
void Scr_Detail_3::Update()
{
	if((atScr_Detail_3.Notified_Bar_old_1.hour != atScr_Detail_3.Notified_Bar_1.hour) || (atScr_Detail_3.Notified_Bar_old_1.minute != atScr_Detail_3.Notified_Bar_1.minute))
	{
		...
		sprintf(atScr_Detail_3.char_time,"%d:%d",atScr_Detail_3.Notified_Bar_old_1.hour,atScr_Detail_3.Notified_Bar_old_1.minute);
		atScr_Detail_3.setup_label(atScr_Detail_3.Screen_label_time,atScr_Detail_3.char_time);
	}
	//check active wifi
