...
void  Scr_Detail_3::Start()
{
	...
	atScr_Detail_3.setup_label(atScr_Detail_3.label_screen,"Detail_3.title",LABEL_POS_X,LABEL_POS_Y,100,32);
	...
	atScr_Detail_3.setup_label(atScr_Detail_3.Screen_label_time,atScr_Detail_3.char_time,ICON_TIME_POS_X,ICON_TIME_POS_Y,ICON_TIME_W,ICON_SIZE);
	// init every events
