...
static void HMI_screen_1_btn_BACK_event_handler(lv_event_t *e)
{
...
void events_init_HMI_screen_1(lv_ui *ui)
{
	lv_obj_add_event_cb(ui->screen_1_btn_BACK, HMI_screen_1_btn_BACK_event_handler, LV_EVENT_ALL, NULL);
}
